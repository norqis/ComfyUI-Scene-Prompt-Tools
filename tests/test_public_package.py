...
class PublicPackageTests(unittest.TestCase):
    def test_runtime_modules_are_in_one_internal_package(self):
        expected = {"__init__.py", "callbacks.py", "lora_metadata.py", "nodes.py", "plan.py", "preset_metadata.py", "prompt.py", "presets.py", "routes.py", "runs.py", "storage.py"}
    ...
    def test_registry_metadata_declares_the_mit_license(self):
        ...
        self.assertIn('version = "0.6.3"', pyproject)
    ...
    def test_private_brand_names_are_absent_from_runtime_ui(self):
        runtime_paths = [Path("__init__.py"), *(Path("scene_prompt_tools") / name for name in (
            "__init__.py", "callbacks.py", "lora_metadata.py", "nodes.py", "plan.py", "preset_metadata.py", "prompt.py", "presets.py", "routes.py", "runs.py", "storage.py",
        ))]
